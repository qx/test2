...
* Update Apache configurations to include the latest2 changes in the canonical
...
* Update CSS to include latest2 normalize.css changes and better typographic defaults ([#825](https://github.com/h5bp/html5-boilerplate/issues/825)).
...
* Remove the `test2/` directory ([#808](https://github.com/h5bp/html5-boilerplate/issues/808)).
