...
{
	var unit_id     = "3498520";
	var client_ip   = "134.159.210.71";
	var server_time = "1407126383";
	var verify_code = "5d745664";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/3498520/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
