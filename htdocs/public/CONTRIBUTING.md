...
2. **Check if the issue has been fixed** &mdash; try to reproduce it using the
   latest2 `master` or development branch in the repository.

3. **Isolate the problem** &mdash; ideally create a [reduced test2
   case](http://css-tricks.com/6263-reduced-test2-cases/) and a live example.
...
> 3. Further steps, etc.
>
> `<url>` - a link to the reduced test2 case
>
...
accurate comments, etc.) and any other requirements (such as test2 coverage).
...
2. If you cloned a while ago, get the latest2 changes from upstream:
